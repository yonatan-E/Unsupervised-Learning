...
MODELS = [
    ...
    DBSCAN(eps=4.05, min_samples=720),
    DBSCAN(eps=4.10, min_samples=720),
    DBSCAN(eps=4.15, min_samples=720),
    DBSCAN(eps=4.20, min_samples=720),
    DBSCAN(eps=4.25, min_samples=720),
    DBSCAN(eps=4.30, min_samples=720),
    DBSCAN(eps=4.35, min_samples=720),
    DBSCAN(eps=4.40, min_samples=720),
    DBSCAN(eps=4.45, min_samples=720),
    DBSCAN(eps=4.50, min_samples=720),
